...
positive integer between 1 and 8, inclusive. (The height of the half-pyramids pictured above happens
...
for row in range(half_pyramid_height):
    ...
    for column in range(half_pyramid_height):
        if half_pyramid_height - row - 1 >= column+1:
            ...
            print("#", end='')
            right_bricks += 1
        if column == half_pyramid_height -1:
            print("  ","#"*right_bricks, sep='', end='')
    print("")
