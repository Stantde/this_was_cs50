...
if __name__ == '__main__':
    main()
'''
#eger, and returns that fraction as a percentage rounded to the nearest int between 0 and 100, inclusive. If X and/or Y is not an integer, or if X is greater than Y, then convert should raise a ValueError. If Y is 0, then convert should raise a ZeroDivisionError.
...
def main():
    x_op_y = input("Fraction: ")
    decimal_percent = convert(x_op_y)
    fuel_gauge = gauge(decimal_percent)
    print(fuel_gauge)
